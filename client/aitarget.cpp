...
void Guitank::attackTargetAi()
{
 ...
 if(this->aiTarget->hp<=0)
 {
  ...
  int trange=range*2/3;
    if(this->x()-aiTarget->x()>-trange&&this->x()-aiTarget->x()<trange)
    {
        if(this->y()-aiTarget->y()>-v&&this->y()-aiTarget->y()<v)
    ...
    if(this->y()-aiTarget->y()>-trange&&this->y()-aiTarget->y()<trange)
    {
        if(this->x()-aiTarget->x()>-v&&this->x()-aiTarget->x()<v)
